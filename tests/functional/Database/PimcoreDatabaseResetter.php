...
namespace Neusta\Pimcore\TranslationMigrationBundle\Tests\Functional\Database;
...
final class PimcoreDatabaseResetter
{
    ...
    private function createSchema(): void
    {
        ...
        if ([] !== $errors = $installer->setupDatabase([])) {
            throw new \RuntimeException(sprintf('Error setting up Pimcore\'s database: "%s"', implode('", "', $errors)));
        }
